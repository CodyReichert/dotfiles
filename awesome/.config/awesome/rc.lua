...
awful.util.spawn_with_shell("wicd")
-- }}}
...
--    os.execute("bash /home/cody/.scripts/cmusinfo")
--    local nowplaying = io.open("/home/cody/.scripts/nowplaying")
--    local l = nil
...
-- 
-- -- cmus
-- cmusicon = wibox.widget.imagebox(beautiful.widget_music)
-- cmuswidget = wibox.widget.textbox( "" )
-- cmuswidget.timer = timer{timeout=5}
-- cmuswidgetbg = wibox.widget.background(cmuswidget, "#313131")
-- 
-- cmuswidget.timer:connect_signal("timeout", function ()
--     cmuswidget:set_text ( nowplaying() )
-- end)

-- start cmus timer
-- cmuswidget.timer:start()
